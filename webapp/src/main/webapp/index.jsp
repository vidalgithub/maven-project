...
<head>
    ...
    <meta name="description" content="Free open source Tailwind CSS EK TECH SOFTWARE SOLUTION Marketplace template">
    <meta name="keywords" content="tailwind,tailwindcss,tailwind css,css,starter template,free templatep template, shop layout, minimal, monochrome, minimalistic, theme, nordic">
                ...
                <div class="block h-full w-full mx-auto flex pt-6 md:pt-0 md:items-center bg-cover bg-right" style="background-image: url('https://images.unsplash.com/photo-1422190441165-ec2956dc9ecc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1600&q=80');">
                    ...
                    <div class="container mx-auto">
                        <div class="flex flex-col w-full lg:w-1/2 md:ml-16 items-center md:items-start px-6 tracking-wide">
                            ...
                            <a class="text-xl inline-block no-underline border-b border-gray-600 leading-relaxed hover:text-black hover:border-black" href="#">Click here to for more info about the product
</a>
                        </div>
                    </div>
...
-->
    ...
    <section class="bg-white py-8">
        ...
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            <nav id="EK TECH SOFTWARE SOLUTION Marketplace" class="w-full z-30 top-0 px-6 py-1">
			...
			p
                    ...
                    <div class="flex items-center" id=p-nav-content">
            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <a href="#">
                    ...
                    <p class="pt-1 text-gray-900">$10.0</p>
                </a>
            </div>
